...
class BusScheduleForm(ModelForm):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.fields['businfo_driver'].queryset = User.objects.filter(parent=user)
        self.fields['businfo_conductor'].queryset = User.objects.filter(parent=user)
        self.fields['businfo_helper'].queryset = User.objects.filter(parent=user)
