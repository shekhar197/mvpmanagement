# Generated by Django 2.1 on 2020-01-02 08:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('businfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='businfo_driver', to='mvpManagement.BusInfo', verbose_name='bus information')),
                ('businfo_condutor', models.ManyToManyField(related_name='businfo_condutor', to=settings.AUTH_USER_MODEL, verbose_name='bus conductor information')),
                ('businfo_driver', models.ManyToManyField(related_name='businfo_driver', to=settings.AUTH_USER_MODEL, verbose_name='bus driver information')),
                ('businfo_helper', models.ManyToManyField(related_name='businfo_helper', to=settings.AUTH_USER_MODEL, verbose_name='bus helper information')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
